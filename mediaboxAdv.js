...
//			NonverBlaster
				playerpath: 'http://dl.dropbox.com/u/27675057/Mediabox%20Advanced/NonverBlaster.swf',	// Path to NonverBlaster.swf
		...
		*/
		mediabox: function(_options, linkMapper, linksFilter) {
			linkMapper = linkMapper || function(el) {
				elrel = el.rel.split(/[\[\]]/);
				elrel = elrel[1];
				return [el.get('href'), el.title, elrel];	// thanks to Du?an Medl?n for figuring out the URL bug!
			};
